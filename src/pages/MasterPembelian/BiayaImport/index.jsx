...
import BiayaImportTable from "../../../components/moleculles/BiayaImportTable";
      ...
      <div className="container   p-3 mb-5 bg-body rounded d-flex flex-column">
        <div className="row">
          <div className="col text-title text-start">
            <h5 className="title fw-bold">Daftar Biaya Import</h5>
          </div>
          {userAccess?.map((d) => {
            if (d.ability_name === "create-customer") {
              return (
                <div className="col button-add text-end me-3">
                  <Link to="/biayaimport/buat">
                    <Button
                      type="primary"
                      icon={<PlusOutlined />}
                    />
