      ...
      .then(function (res) {
        ...
        axios({
          ...
          .then(function (res) {
            //handle success
            console.log(res);
            Swal.fire("Alamat Berhasil Ditambahkan", `Alamat ${code} Berhasil Ditambah`, "success");
            navigate(`/supplier`);
  ...
  const getSupplierById = async () => {
    await axios.get(`${Url}/suppliers?id=${id}`, {
      ...
      .then((res) => {
        ...
        setAddress(getData.supplier_addresses);
      })
      .catch((err) => {
        // Jika Gagal
        console.log(err);
    ...
    <>
      <form className="  p-3 mb-4 bg-body rounded">
        <div className="text-title text-start mb-4">
          ...
          {/* <h3 className="title fw-bold">Edit Supplier</h3> */}
        </div>
