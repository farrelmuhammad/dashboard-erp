...
import { BarsOutlined, DeleteOutlined, LoadingOutlined, MinusOutlined, PlusOutlined,  EditOutlined, PrinterOutlined } from '@ant-design/icons'
                    ...
                    <div className="col text-title text-start">
                        {
                            canEdit ?
                                <PageHeader
                                    ...
                                    extra={[
                                        <Link to={`/tallypembelian/edit/${id}`}>
                                            <Button
                                                type="primary"
                                                icon={<EditOutlined />}
                                            />
